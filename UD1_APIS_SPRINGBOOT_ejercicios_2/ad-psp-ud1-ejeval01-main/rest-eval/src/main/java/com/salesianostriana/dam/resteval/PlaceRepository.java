...
public class PlaceRepository {
    ...
    public void init() {
        ...
        add(Place.builder().id(1L).name("Las Niñas").address("Calle Malvaloca, 17").coords("1.121212121, 4.212312341").desc("Un sitio donde ni Falete se queda con hambre").image("Imagen de un bar").build());
        add(Place.builder().id(2L).name("Bar Galindón").address("Calle Cánovas del Castillo, 84").coords("2.121212412415, 6.1241241561").desc("El mejor bar que hay en la Puebla de los Infantes").image("Imagen de un bar").build());
    }
