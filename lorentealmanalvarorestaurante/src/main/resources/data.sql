DROP SEQUENCE RESTAURANTE_SEQ IF EXISTS;
DROP SEQUENCE TAG_SEQ IF EXISTS;
...
INSERT INTO TAGS (ID, NOMBRE) VALUES (NEXTVAL('TAG_SEQ'),'Cocina local');
INSERT INTO TAGS (ID, NOMBRE) VALUES (NEXTVAL('TAG_SEQ'),'Café');
INSERT INTO TAGS (ID, NOMBRE) VALUES (NEXTVAL('TAG_SEQ'),'Sin niños');
INSERT INTO TAGS (ID, NOMBRE) VALUES (NEXTVAL('TAG_SEQ'),'Comida japonesa');

INSERT INTO RESTAURANTE_TAG(RESTAURANTE_ID, TAG_ID)VALUES(1,1);
INSERT INTO RESTAURANTE_TAG(RESTAURANTE_ID, TAG_ID)VALUES(3,1);
